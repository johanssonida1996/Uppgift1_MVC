...
namespace Uppgift1_ASP.Net.Controllers
{
    public class StudentsController : Controller
    {
        private readonly Uppgift1DbContext _context;
        private readonly UserManager<AppUser> _userManager;

        public StudentsController(Uppgift1DbContext context, UserManager<AppUser> userManager)
        {
            _context = context;
        ...
        {
            var uppgift1DbContext = _context.SchoolClassStudents.Include(s => s.SchoolClass);
            return View(await uppgift1DbContext.ToListAsync());
        }
